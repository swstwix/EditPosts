...
(function() {
    ...
    (function() {
        var l = function(u) { u.collapsed = u.startContainer && u.endContainer && u.startContainer.equals(u.endContainer) && u.startOffset == u.endOffset; }, m = function(u, v, w, x) {
            u.optimizeBookmark();
        ...
        function q(u) {
            return function(v) { return !u && p(v) || (v.type == 3 ? !e.trim(v.getText()) || !!v.getParent().data('cke-bookmark') : v.getName() in f.$removeEmpty); };
        }
    ...
    (function() {
        var m = function(y, z) {
            var A = y.document, B = A.getBody(), C = false, D = function() { C = true; };
            B.on(z, D);
            ...
            function r(t, u, v) {
                var w = [], x = n.colorButton_colors.split(','), y = e.addFunction(function(E, F) {
                    ...
                    if (E) {
                        ...
                        I.childRule = F == 'back' ? function(J) { return s(J); } : function(J) { return !(J.is('a') || J.getElementsByTag('a').count()) || s(J); };
    ...
    (function() {
        ...
        function m(n, o, p, q, r, s, t) {
            ...
            n.ui.addRichCombo(o, {
                ...
                panel: { css: n.skin.editor.css.concat(u.contentsCss), multiSelect: false, attributes: { 'aria-label': q.panelTitle } },
                init: function() {
    ...
    j.add('format', {
        ...
        init: function(m) {
            ...
            m.ui.addRichCombo('Format', {
                ...
                panel: { css: m.skin.editor.css.concat(n.contentsCss), multiSelect: false, attributes: { 'aria-label': o.panelTitle } },
                init: function() {
    ...
    (function() {
        ...
        function J(T) {
            return T.replace(D, function(U) { return '<cke:encoded>' + encodeURIComponent(U) + '</cke:encoded>'; });
        }

        ;

        function K(T) {
            return T.replace(E, function(U, V) { return decodeURIComponent(V); });
        }
        ...
        function P(T) {
            return T.replace( /<!--(?!{cke_protected})[\s\S]+?-->/g , function(U) { return '<!--' + n + '{C}' + encodeURIComponent(U).replace( /--/g , '%2D%2D') + '-->'; });
        }

        ;

        function Q(T) {
            return T.replace( /<!--\{cke_protected\}\{C\}([\s\S]+?)-->/g , function(U, V) { return decodeURIComponent(V); });
        }
    ...
    (function() {
        var m = { ol: 1, ul: 1 }, n = /^[\n\r\t ]*$/ , o = d.walker.whitespaces(), p = d.walker.bookmark(), q = function(L) { return !(o(L) || p(L)); }, r = d.walker.bogus();
    ...
    (function() {
        ...
        function t(C) {
            if (!C.checkDirty()) setTimeout(function() { C.resetDirty(); }, 0);
        }
                ...
                C.on('editingBlockReady', function() {
                    ...
                    function V(W) {
                        ...
                        if (c && X.$.compatMode == 'CSS1Compat') {
                            var ae = { 33: 1, 34: 1 };
                            X.on('keydown', function(af) { if (af.data.getKeystroke() in ae) setTimeout(function() { C.getSelection().scrollIntoView(); }, 0); });
                        }
                    ...
                    C.addMode('wysiwyg', {
                        ...
                        focus: function() {
                            ...
                            if (N) O = true;
                                ...
                                b.air ? setTimeout(function() { W.focus(); }, 0) : W.focus();
                                C.selectionChange();
                            }
                        }
                    });
    ...
    (function() {
        ...
        e.extend(a.dialog, {
            add: function(S, T) { if (!this._.dialogDefinitions[S] || typeof T == 'function') this._.dialogDefinitions[S] = T; },
    ...
    (function() {
        ...
        function L(T, U) {
            for (var V in T) T[V] = T[V].replace(p, function(W, X) { return U[X]; });
        }
    ...
    (function() {
        ...
        j.add('selection', {
            init: function(z) {
                if (b.webkit) {
                    z.on('selectionChange', function() { v(z.document); });
        ...
        d.selection.prototype = {
            ...
            getSelectedElement: function() {
                ...
                var A = this, B = e.tryThese(function() { return A.getNative().createRange().item(0); }, function() {
